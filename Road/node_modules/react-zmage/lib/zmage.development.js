...
exports.locals = {
	...
	"zoomButton": "zoomButton__2hcz6",
	"closeButton": "closeButton__X8X4o",
...
var checkImageLoadedCompleteTimer;
var checkImageLoadedComplete = function checkImageLoadedComplete(imageRef, callback) {
...
function (_React$PureComponent) {
  ...
  function Images(props) {
    ...
    Image_defineProperty(Image_assertThisInitialized(Image_assertThisInitialized(_this)), "handleImageLoading", function () {
      ...
      _this.setState(Image_objectSpread({
        ...
        _this.imageLoadingTimer = checkImageLoadedComplete(_this.currentImageRef.current, _this.handleImageLoaded);
      });
    });

    Image_defineProperty(Image_assertThisInitialized(Image_assertThisInitialized(_this)), "handleImageLoaded", function () {
  ...
  Image_createClass(Images, [{
    ...
    value: function render() {
      ...
      var imgClassNames = external_classnames_default()(Image_default.a.imageLayer, set[page].className, (_classnames = {}, Image_defineProperty(_classnames, Image_default.a.zooming, zoom), Image_defineProperty(_classnames, Image_default.a.didInvalidate, didInvalidate), _classnames));
