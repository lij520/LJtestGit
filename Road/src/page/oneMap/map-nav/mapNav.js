...
const treeData = [{title:<div ><img src={navIcons[0]} alt='road-icon' height="16" width='16'/> 各级道路</div>,
   key:'0',
   children: [
  ...
  children: [
    ...
    //   key: '2-1' ,
    //   children:[
    //     {title:'破坏公路',key:'0101'},//'roadDamage'
    //     {title:'违章搭建',key:'0102'},//'violation'
    //     {title:'乱堆乱放',key:'0103'},//'huddle'
    //   ]
    // },
    // { title: <div ><img src={navIcons[8]} alt='quality-icon' height="16" width='16'/> 养护质量问题</div>,
    //   key: '2-2' ,
    //   children:[
    //     {title:'养护工人未上岗',key:'0201'},//'absenteeism'
    //     {title:'道路养护质量差',key:'0202'}//'poorQuality'
    //   ]
    // },
    // { title: <div ><img src={navIcons[9]} alt='roadBridge-icon' height="16" width='16'/> 公路桥梁损毁</div>, 
    //   key: '2-3' ,
    //   children:[
    //     {title:'路基损毁',key:'0301'},//'roadbedDamage'
    //     {title:'路面损毁',key:'0302'},//'pavementDamege'
    //     {title:'排水沟损毁',key:'0303'},//'ditchDamage'
    //     {title:'涵洞损毁',key:'0304'},//'culvertDamage'
    //     {title:'桥梁损毁',key:'0305'},//'bridgeDamege'
    //     {title:'边坡损毁',key:'0306'},//'sideSlopeDamage'
    //     {title:'安防设施损毁',key:'0307'},//'protectionDamage'
    //     {title:'隧道损毁',key:'0308'}//'tunnelDamage'
    //   ]
    // },
    { title: <div ><img src={navIcons[12]} alt='right-icon' height="16" width='16'/> 路政类</div>, 
      key: '2-1' ,
      children:[
          {title:'违规占道',key:'1001'},
          {title:'违章搭建',key:'1002'},
    ...
    { title: <div ><img src={navIcons[13]} alt='right-icon' height="16" width='16'/> 路基</div>, 
      key: '2-2' ,
      children:[
          {title:'路基坍塌',key:'2001'},
          {title:'边坡损毁',key:'2002'},
    ...
    { title: <div ><img src={navIcons[14]} alt='quality-icon' height="16" width='16'/> 路面</div>,
      key: '2-3' ,
      children:[
        {title:'路面脏污',key:'2101'},
        {title:'路面破损',key:'2102'},
    ...
    { title: <div ><img src={navIcons[15]} alt='roadBridge-icon' height="16" width='16'/> 桥梁</div>, 
      key: '2-4' ,
      children:[
    ...
    { title: <div ><img src={navIcons[16]} alt='right-icon' height="16" width='16'/> 隧道</div>, 
      key: '2-5' ,
      children:[
          {title:'衬砌裂缝',key:'2301'},
          {title:'衬砌漏水',key:'2302'},
    ...
    { title: <div ><img src={navIcons[17]} alt='quality-icon' height="16" width='16'/> 水沟涵洞</div>,
      key: '2-6' ,
      children:[
        {title:'排水堵塞',key:'2401'},
        {title:'倒塌破损',key:'2402'}
    ...
    { title: <div ><img src={navIcons[18]} alt='roadBridge-icon' height="16" width='16'/> 设施、标志牌</div>, 
      key: '2-7' ,
      children:[
