...
class RoadProtectAdd extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            userId              : '5',
    ...
    handleChange (params){
      ...
      console.log(this.state.percent);
       ...
       onSubmit(){
        ...
        formData.append("maintenanceTime ",this.state.eventTime)
        ...
        formData.append("maintenanceProblemType",this.state. problemType),
        formData.append("maintenancePoint",this.state. eventPoint),
        formData.append("maintenanceContent",this.state. eventContent),
        ...
        this.state.fileData.forEach((file)=>{
            ...
            $.ajax({
                type        :  'post',
                url         :  'http://localhost:13077/maintenance/newMaintenanceByPc', 
                // dataType    :  'json',
                // data        :  user,
                data:  formData,
                dataType: "formData",
