...
class NewsList extends React.Component{
    ...
    // onEditNews(a) {
    //   console.log('编辑');
    //   const newsId = this.state.list[a].newsId;
    //   window.location.href='/#/news/editNews?newsId='+ newsId;
    // } 
    cancel(e) {
      console.log(e);
    }
      ...
      return (
        <div>
            <List 
                ...
                // }}
                pagination={{ onChange: (page) => {console.log('page:',page);}, pageSize: 3}}
                dataSource={listData}
                  ...
                  <List.Item
                      ...
                      actions={
                        ...
                        : [<Popconfirm title="确认删除此新闻?" placement="rightBottom" onConfirm={() => this.onDeleteNews(`${item.newsId}`)} onCancel={(e) => this.cancel(e)} okText="确定" cancelText="取消"><a href="javascript:;"><Icon type="delete" style={{ marginRight: 8 }} />删除</a></Popconfirm>
                          ,<Link to={ `/news/editNews/${item.newsId}`}><Icon type="edit" style={{ marginRight: 8 }} />编辑</Link>]
                      }
