...
class BackMaps extends React.Component{
    componentDidMount(){
        // 基于准备好的dom，初始化echarts实例
        echarts.registerMap('fujian', fujianJson);
        echarts.registerMap('FJMap',fujianData);
        var myChart=echarts.init(document.getElementById('main-back'));
        ...
        var FJDataScatter = [
            ...
            {name:'上杭',value:74},
            {name:'三明',value:74},
            // [{name:'长汀'}, {name:'三明',value:75}],
            // [{name:'上杭'}, {name:'长汀',value:75}],
            // [{name:'上杭'}, {name:'大田',value:75}],
            // [{name:'大田'}, {name:'泉州',value:75}],
            // [{name:'泉州'}, {name:'漳州',value:73}],
            // [{name:'罗源'}, {name:'平潭综合实验区',value:66}],
            // [{name:'三明'}, {name:'建阳',value:64}],
            // [{name:'Q4'}, {name:'三明',value:66}],
            // [{name:'福州'}, {name:'Q4',value:66}],
            // [{name:'罗源'}, {name:'福州',value:66}],
            // [{name:'罗源'}, {name:'罗源',value:36}],
        ]
        var geoCoordMap = {
            '福建省': [119.306239,26.075302],
            '福州': [119.306239,26.075302],
        ...
        var FJData = [
            // [{name:'福建省'}, {name:'漳州',value:92}],
            // [{name:'福建省'}, {name:'三明',value:73}],
            // [{name:'福建省'}, {name:'平潭综合实验区',value:91}],
            // [{name:'福建省'}, {name:'上杭',value:75}],
            [{name:'福安'}, {name:'福安',value:96}],
            [{name:'F1'}, {name:'福安',value:64}],
            [{name:'F1'}, {name:'F1',value:64}],
            [{name:'福建省'}, {name:'福州',value:90}],
            [{name:'福安'}, {name:'罗源',value:66}],
            [{name:'上杭'}, {name:'上杭',value:74}],
            [{name:'三明'}, {name:'三明',value:74}],
            [{name:'长汀'}, {name:'三明',value:75}],
            [{name:'上杭'}, {name:'长汀',value:75}],
            [{name:'上杭'}, {name:'大田',value:75}],
            [{name:'大田'}, {name:'泉州',value:75}],
                ...
                lineStyle: {
                    normal: {
                        color: function(params){
                            return colorChange(params.value)
                        }, 
                        width: 0,
                        opacity: 0.6,
                        curveness: 0.2
        ...
        var option = {
            ...
            // },
            {
                ...
                roam: false,
                zoom:1.8,
                center: [116.806239,26.175302],//中心点
                itemStyle: {
                    normal: {
                        // areaColor: '#071A44',
                        areaColor: 'transparent',
    ...
    render(){
        ...
        return(
            <div id="main-back" style={{position:'absolute',width:'100%',height:'100%'}}></div>
        )
    }
}

export default BackMaps;